...
--
-- Host: localhost    Database: DBMS11_2505060076
-- ------------------------------------------------------
...
CREATE TABLE `tbpegawai` (
  ...
  PRIMARY KEY (`NIP`),
  KEY `fk_golongan` (`gol`),
  CONSTRAINT `fk_golongan` FOREIGN KEY (`gol`) REFERENCES `tbgaji` (`Gol`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-04-07 17:55:12
